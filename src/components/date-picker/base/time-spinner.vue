  ...
  <div :class="classes">
    <div :class="[prefixCls+ '-list']" ref="hours">
      <ul :class="[prefixCls + '-ul']">
        <li :class="getCellCls(item)" v-for="(item, index) in hoursList" :key="index" v-show="!item.hide" @click="handleClick('hours', item)">
    ...
    <div :class="[prefixCls+ '-list']" ref="minutes">
      <ul :class="[prefixCls + '-ul']">
        <li :class="getCellCls(item)" v-for="(item, index) in minutesList" :key="index" v-show="!item.hide"
    ...
    <div :class="[prefixCls+ '-list']" v-show="showSeconds" ref="seconds">
      <ul :class="[prefixCls + '-ul']">
        <li :class="getCellCls(item)" v-for="(item, index) in secondsList" :key="index" v-show="!item.hide"
